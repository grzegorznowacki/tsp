...
path_len, edges_len_list = algorithms_utils.calculate_path_length_based_on_indices_path_list(indices_list_all, points_list_all)
### second path ###
...
path_len_second, edges_len_list_second = algorithms_utils.calculate_path_length_based_on_indices_path_list(indices_list_all_second, points_list_all)
end_time = time.time()

utils.save_paths_to_file(indices_list_all, indices_list_all_second, OUTPUT_FILE_PATH_SQUARES)
utils.save_edges_len_to_file(edges_len_list, edges_len_list_second, EDGES_OUTPUT_FILE_PATH_SQUARES)
